...
public class SpriteLoader : MonoBehaviour {
	...
	void Awake () {
        ...
        //Recieves the size of the image, width and hight
        ...
        //Allocates the correct UV coordinates depending on the size of the image or resource
        foreach (Sprite s in sprites)
        {
